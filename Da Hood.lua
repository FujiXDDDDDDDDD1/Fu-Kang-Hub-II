...
local TpsTab = Window:AddTab("Teleport")
local CreditTAB = Window:AddTab("Credits")

local folder = TpsTab:AddFolder("Weapons")
folder:AddButton("Double-Baeerl", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1039.81433, 21.7499943, -256.584991, -0.99979347, -5.26766897e-09, 0.0203231238, -3.54385521e-09, 1, 8.48563317e-08, -0.0203231238, 8.47667891e-08, -0.99979347)
end)

folder:AddButton("Revolver", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-638.965149, 21.7499962, -118.281952, -0.999901831, 3.33962262e-08, -0.0140123479, 3.42626052e-08, 1, -6.15897093e-08, 0.0140123479, -6.20637621e-08, -0.999901831)
end)

folder:AddButton("Taser", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(328.997223, 50.0735931, -760.404358, -0.999998808, -2.24656578e-08, -0.00154628558, -2.24404548e-08, 1, -1.6315731e-08, 0.00154628558, -1.62810121e-08, -0.999998808)
end)

folder:AddButton("Flamethrower", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-157.054214, 53.8106041, -105.188965, 0.99999851, 3.78079577e-08, 0.00171944976, -3.77922653e-08, 1, -9.15994214e-09, -0.00171944976, 9.09494613e-09, 0.99999851)
end)

folder:AddButton("RPG", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(114.004929, -26.7500343, -272.478668, 0.999930561, 5.34063922e-08, 0.0117822811, -5.23269996e-08, 1, -9.19197944e-08, -0.0117822811, 9.12968829e-08, 0.999930561)
end)

local folder2 = TpsTab:AddFolder("Locations")
folder2:AddButton("Uphill Gunz", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(482.17865, 48.0049896, -609.119568, -0.98736465, 3.11552455e-08, -0.158464745, 3.88239876e-08, 1, -4.52983215e-08, 0.158464745, -5.08781923e-08, -0.98736465)
end)
 
folder2:AddButton("Downhill Gunz", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-568.520935, 7.99984598, -736.302124, -0.008291509, 3.11082218e-08, -0.999965608, -3.67959174e-08, 1, 3.14143946e-08, 0.999965608, 3.70551234e-08, -0.008291509)
end)

folder2:AddButton("Da Casino", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-903.787476, 21.3749943, -166.869278, 0.999147832, -1.0680769e-07, -0.0412752293, 1.05070285e-07, 1, -4.4262503e-08, 0.0412752293, 3.98879827e-08, 0.999147832)
end)

folder2:AddButton("Cinema", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1006.24799, 24.6000137, -154.269073, 0.999708056, 1.22777815e-08, 0.0241621286, -1.14297025e-08, 1, -3.52376119e-08, -0.0241621286, 3.49511566e-08, 0.999708056)
end)

folder2:AddButton("NBA", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-931.668213, 21.9998207, -482.466217, 0.00847437978, -3.70175712e-08, 0.999964118, -2.31844464e-08, 1, 3.72153792e-08, -0.999964118, -2.34989912e-08, 0.00847437978)
end)

folder2:AddButton("Da Bank", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-419.81897, 24.0497513, -285.546631, 0.0121334363, -4.44778578e-08, -0.999926388, 1.2502861e-08, 1, -4.43294184e-08, 0.999926388, -1.19640724e-08, 0.0121334363)
end)

folder2:AddButton("Klips", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(12.6469221, 21.7499943, -115.227348, 0.770390272, 4.72853792e-08, -0.637572587, -3.53796352e-08, 1, 3.14148565e-08, 0.637572587, -1.644613e-09, 0.770390272)
end)

folder2:AddButton("School", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-624.8974, 21.2499981, 222.247299, 0.990782619, -1.35153488e-08, -0.135461316, 6.84594381e-09, 1, -4.9700585e-08, 0.135461316, 4.83151155e-08, 0.990782619)
end)

folder2:AddButton("Barracks", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(39.3911095, 25.2549973, -874.486572, 0.0612745248, 3.47731195e-08, 0.998120964, -8.88529001e-08, 1, -2.9383914e-08, -0.998120964, -8.68854571e-08, 0.0612745248)
end)

folder2:AddButton("Da Boxing Club", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-214.172577, 21.7549973, -1119.83655, 0.0354492217, 2.60946589e-08, -0.999371469, -1.59277249e-08, 1, 2.55460897e-08, 0.999371469, 1.50121249e-08, 0.0354492217)
end)
 
folder2:AddButton("Filming", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-495.93042, 48.8524704, -220.95015, 0.00783392228, -3.96097238e-10, 0.999969304, 5.86915716e-09, 1, 3.50129453e-10, -0.999969304, 5.86623417e-09, 0.00783392228)
end)

folder2:AddButton("Bar 1", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-664.311951, 23.1405334, -122.509438, 0.00240413193, 1.09756193e-09, -0.999997139, -1.81424109e-09, 1, 1.09320342e-09, 0.999997139, 1.81160764e-09, 0.00240413193)
end)

folder2:AddButton("Bar 2", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-265.010223, 48.5266991, -452.941498, 0.998896837, 2.63034217e-09, 0.0469581783, -6.81647128e-10, 1, -4.15145323e-08, -0.0469581783, 4.14367278e-08, 0.998896837)
end)

folder2:AddButton("Admin", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-797.690002, -39.6492119, -884.366394, -0.981901646, 1.13318617e-08, -0.189391494, -1.16798526e-08, 1, 1.20387284e-07, 0.189391494, 1.20420538e-07, -0.981901646)
end)

folder2:AddButton("Safe Zone", function(bool)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-66.7253647, -58.7000694, 163.234497, 0.994780004, 6.93854005e-08, 0.102042682, -7.7234894e-08, 1, 7.29727034e-08, -0.102042682, -8.04730433e-08, 0.994780004)
end)
...
RCTab:AddButton("Spaceware", function(bool)
...
RCTab:AddButton("Animaion", function(bool)
