...
if
 ...
 then
    writefile("Fu Kang Hub NextGeneration//" .. Name, HttpService:JSONEncode(Des))
end
if readfile("Fu Kang Hub NextGeneration//" .. Name) then
Settings = HttpService:JSONDecode(readfile("Fu Kang Hub NextGeneration//" .. Name))
end
local function Save()
    writefile("Fu Kang Hub NextGeneration//" .. Name, HttpService:JSONEncode(Settings))
end

local Connections = {
    Workspace:FindFirstChild("CCoff"),
    Workspace:FindFirstChild("custo"),
    Workspace:FindFirstChild("conquer"),
    Workspace.GLOBALTIME:FindFirstChild("narutoshadowclone"),
}
...
local Kill = function()
    if not Player.PlayerGui:FindFirstChild("Main") and wait(2) then
